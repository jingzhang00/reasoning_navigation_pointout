...
from world_percept_assig3.msg import NavigateDrinkAction, NavigateDrinkFeedback, NavigateDrinkResult
import json


file_path = '/home/user/exchange/ssy236_project/rearrange_ws/src/world_percept_assig3/queries/object_pose.json'
