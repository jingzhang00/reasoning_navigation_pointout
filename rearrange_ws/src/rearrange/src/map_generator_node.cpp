...
#include <rearrange/UpdateObjectList.h>
#include <rearrange/SetInitTiagoPose.h>

//add the new libraries for the new service
#include <rearrange/GetSceneObjectList.h>
...
*/
    ...
    bool srv_update_callback(rearrange::UpdateObjectList::Request  &req,
            rearrange::UpdateObjectList::Response &res)
    {
...
/**
     ...
     */
    bool srv_get_scene_obj_callback(rearrange::GetSceneObjectList::Request &req,
                                    rearrange::GetSceneObjectList::Response &res)
    {
