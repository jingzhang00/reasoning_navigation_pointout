...
import os
from rearrange.srv import GetSceneObjectList, GetSceneObjectListRequest
...
def expected_location(objects_list):
    ...
    prolog = Prolog()
    prolog.consult('/home/user/exchange/ssy236_project/rearrange_ws/src/rearrange/prolog/instance_utils.pl')
...
if __name__ == '__main__':
    ...
    package_path = rospack.get_path('rearrange')
