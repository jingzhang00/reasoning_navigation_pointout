...
(cl:defmethod cl:initialize-instance :after ((m <GetSceneObjectList-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetSceneObjectList-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rearrange-srv:<GetSceneObjectList-request> is deprecated: use rearrange-srv:GetSceneObjectList-request instead.")))

(cl:ensure-generic-function 'object_name-val :lambda-list '(m))
(cl:defmethod object_name-val ((m <GetSceneObjectList-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rearrange-srv:object_name-val is deprecated.  Use rearrange-srv:object_name instead.")
  (object_name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetSceneObjectList-request>)))
  ...
  "rearrange/GetSceneObjectListRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetSceneObjectList-request)))
  "Returns string type for a service object of type 'GetSceneObjectList-request"
  "rearrange/GetSceneObjectListRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetSceneObjectList-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetSceneObjectList-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rearrange-srv:<GetSceneObjectList-response> is deprecated: use rearrange-srv:GetSceneObjectList-response instead.")))

(cl:ensure-generic-function 'obj_found-val :lambda-list '(m))
(cl:defmethod obj_found-val ((m <GetSceneObjectList-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rearrange-srv:obj_found-val is deprecated.  Use rearrange-srv:obj_found instead.")
  (obj_found m))

(cl:ensure-generic-function 'objects-val :lambda-list '(m))
(cl:defmethod objects-val ((m <GetSceneObjectList-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rearrange-srv:objects-val is deprecated.  Use rearrange-srv:objects instead.")
  (objects m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <GetSceneObjectList-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rearrange-srv:message-val is deprecated.  Use rearrange-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetSceneObjectList-response>)))
  ...
  "rearrange/GetSceneObjectListResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetSceneObjectList-response)))
  "Returns string type for a service object of type 'GetSceneObjectList-response"
  "rearrange/GetSceneObjectListResponse")
